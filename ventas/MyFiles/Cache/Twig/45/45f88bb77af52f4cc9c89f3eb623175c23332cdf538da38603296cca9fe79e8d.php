...
class __TwigTemplate_f3fd015cb2787cac298cae9f9fe201d96f22c4b1cba0238659b6ed7600d5c085 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
            ...
            foreach ($context['_seq'] as $context["viewName"] => $context["view"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["view"], "settings", [], "any", false, false, false, 38), "active", [], "any", false, false, false, 38)) {
                    ...
                    echo "                                <li class=\"nav-item\">
                                    ";
                    // line 40
                    $context["active"] = ((((0 === twig_compare($context["viewName"], twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "active", [], "any", false, false, false, 40))) || ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "active", [], "any", false, false, false, 40), ($context["firstViewName"] ?? null))) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 40), 1))))) ? (" active") : (""));
                    // line 41
                    echo "                                    <a href=\"#";
                    ...
                    echo "</span>
                                        ";
                    // line 44
                    if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["view"], "count", [], "any", false, false, false, 44), 0))) {
                        // line 45
        ...
        foreach ($context['_seq'] as $context["viewName"] => $context["view"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["view"], "settings", [], "any", false, false, false, 57), "active", [], "any", false, false, false, 57)) {
                // line 58
                echo "                    ";
                $context["active"] = ((((0 === twig_compare($context["viewName"], twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "active", [], "any", false, false, false, 58))) || ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "active", [], "any", false, false, false, 58), ($context["firstViewName"] ?? null))) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 58), 1))))) ? (" show active") : (""));
                // line 59
...
";
    ...
    {
        return new Source("", "Master/PanelControllerBottom.html.twig", "C:\\xampp\\htdocs\\ventas\\Dinamic\\View\\Master\\PanelControllerBottom.html.twig");
    }
}
